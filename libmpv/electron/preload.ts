...
contextBridge.exposeInMainWorld("electron", {
  ...
  // off). This keeps wall images out of the browser process entirely: serving them over the
  // coolmedia:// protocol made the main process retain a working set proportional to the bytes
  // pushed through it (hundreds of MB on a big wall) — with direct reads, main never sees them.
